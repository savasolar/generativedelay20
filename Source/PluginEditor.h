...
private:
    ...
    juce::TextButton section1_RunButton;
    juce::TextButton section1_PlayButton;
    juce::TextEditor section1_InputBox;
    
    juce::TextButton section2_RunButton;
    juce::TextButton section2_PlayButton;
    juce::TextEditor section2_InputBox;
    
    juce::TextButton section3_RunButton;
    juce::TextButton section3_PlayButton;
    juce::TextEditor section3_InputBox;
    
    juce::TextButton section4_RunButton;
    juce::TextButton section4_PlayButton;
    juce::TextEditor section4_InputBox;
    ...
    WaveformViewer section2_waveform;
    WaveformViewer section3_waveform;
